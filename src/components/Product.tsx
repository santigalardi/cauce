...
const STEPS = [
  ...
  },
  {
    ...
    description:
      "Una vez confirmados los detalles, Cauce envía recordatorios al paciente, reduciendo las inasistencias y optimizando los horarios.",
  },
];
...
const CHAT = [
  ...
  {
    side: "bot" as const,
    text: "Hola María 👋 Soy el asistente de Centro Médico. Veo que el Dr. Pereyra (Cardiología) tiene disponibles:",
    time: "10:42",
    delay: 0.9,
  },
  {
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 relative">
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 30% 20%, rgba(212,165,92,0.25), transparent 60%)",
              }}
            />
            ...
            {/* Stat badge flotante */}
            <div className="hidden lg:flex absolute -right-4 top-32 z-20 bg-brand text-paper-warm px-4 py-3 rounded-xl shadow-xl rotate-[3deg] items-center gap-3">
              <div>
